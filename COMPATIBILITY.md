...
This file is the published compatibility contract for **BDVM.Common 1.0.0**. It describes the current incremental release; it is not a promise that BDVM is feature-complete.
